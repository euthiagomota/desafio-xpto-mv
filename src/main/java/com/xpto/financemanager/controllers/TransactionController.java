...
public class TransactionController {
    ...
    public ResponseEntity<ResponseTransactionDto> create(
            @javax.validation.Valid @RequestBody RequestTransactionDto dto,
            @PathVariable("transactionType") TransactionType transactionType
            ) {
        ResponseTransactionDto response = this.transactionService.createTransaction(dto, transactionType);
